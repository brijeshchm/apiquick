...
class WebsiteController extends Controller
{
	...
	public function getKeyword(Request $request)
	{
		...
		$data['keyword'] = array(
			...
			'bottom_heading' => preg_replace('/in {{city}}/i', ucfirst($city), $keywordDetails->bottom_heading),
			'top_heading' => preg_replace('/in {{city}}/i', ucfirst($city), $keywordDetails->top_heading),
			'extra_heading' => preg_replace('/in {{city}}/i', ucfirst($city), $keywordDetails->extra_heading),
			'extra_description' => preg_replace('/in {{city}}/i', ucfirst($city), $keywordDetails->extra_description),
		 
			
			
			
			
			'faqa1' => preg_replace('/in {{city}}/i', ucfirst($city), $keywordDetails->faqa1),
			'faqq2' => preg_replace('/in {{city}}/i', ucfirst($city), $keywordDetails->faqq2),
			'faqa2' => preg_replace('/in {{city}}/i', ucfirst($city), $keywordDetails->faqa2),
			'faqq3' => preg_replace('/in {{city}}/i', ucfirst($city), $keywordDetails->faqq3),
			'faqa3' => preg_replace('/in {{city}}/i', ucfirst($city), $keywordDetails->faqa3),
			'faqq4' => preg_replace('/in {{city}}/i', ucfirst($city), $keywordDetails->faqq4),
			'faqa4' => preg_replace('/in {{city}}/i', ucfirst($city), $keywordDetails->faqa4),
			'faqq5' => preg_replace('/in {{city}}/i', ucfirst($city), $keywordDetails->faqq5),
			'faqa5' => preg_replace('/in {{city}}/i', ucfirst($city), $keywordDetails->faqa5),
			
			'faqq6' => preg_replace('/in {{city}}/i', ucfirst($city), $keywordDetails->faqq6),
			'faqa6' => preg_replace('/in {{city}}/i', ucfirst($city), $keywordDetails->faqa6),

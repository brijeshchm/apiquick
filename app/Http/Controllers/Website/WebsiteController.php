...
/**
	...
	public function searchCategories(Request $request)
	{
		...
		$data['keyword'] = array(
			...
			'meta_title' => $meta_title,
			'h1_heading' => $h1_heading,
			'heading' => $categoryDetails->heading,
			'courseabout' => $categoryDetails->courseabout,
			'paragraph1' => $categoryDetails->paragraph1,
			'paragraph2' => $categoryDetails->paragraph2,
			'paragraph3' => $categoryDetails->paragraph3,
			'paragraph4' => $categoryDetails->paragraph4,
			'paragraph5' => $categoryDetails->paragraph5,
			'paragraph6' => $categoryDetails->paragraph6,
			'meta_description' => $meta_description,
	...
	public function searchChild(Request $request)
	{
		...
		if (!empty($childDetails->pc_icon)) {
			...
			if (!empty($childicons)) {
				$child_icon = config('app.website') . $childicons['pc_icon']['src'];
		...
		$data['keyword'] = array(
			...
			'paragraph1' => $childDetails->paragraph1,
			'paragraph2' => $childDetails->paragraph2,
			'paragraph3' => $childDetails->paragraph3,
			'paragraph4' => $childDetails->paragraph4,
			'paragraph5' => $childDetails->paragraph5,
			'paragraph6' => $childDetails->paragraph6,
			'meta_description' => $meta_description,
	...
	{
		 $data['cities'] = City::select('id','city','city_slug')->where('popular','1')->get();
